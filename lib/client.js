	...
	factory: (require) => {
		...
		if (typeof document !== "undefined") {
			...
			if (existing === null) {
				...
				tag.textContent = fullCss;
				document.head.appendChild(tag);
			} else if (existing.textContent !== fullCss) {
				// HMR rebuilds keep the old <style> tag; refresh its content so
				// CSS changes (e.g. the orphan horizontal-bar layout) apply live.
			...
			* order is never changed by the toolbar controls. */
			...
			const installedView = (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
				children: [
					...
					// Orphan section: unmounted plugin files listed BELOW the normal
					// installed plugins, in their own grid (restarts the row flow)
					// with a section title. Gray cards, with mount (declared) or
					// delete-files (residue) actions.
					orphans !== null && orphans.length > 0 ? (0, react_jsx_runtime.jsxs)("div", {
						className: "dshm_orphanSection",
						"data-orphan-section": "true",
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								className: "dshm_catalogHeading dshm_orphanHeading",
								children: [
									(0, react_jsx_runtime.jsx)("h3", { children: t("orphansTitle") }),
									(0, react_jsx_runtime.jsx)("span", { "data-plugin-count": orphans.length, children: `${orphans.length}` })
								]
							}),
							(0, react_jsx_runtime.jsx)("div", {
								className: "dshm_scroll",
								children: [
									(0, react_jsx_runtime.jsx)("ul", {
										className: rowView === "wide" ? "dshm_cards dshm_orphanCards" : "dshm_rows dshm_orphanRows",
										children: orphans.map((orphan) => {
											...
											if (rowView === "wide") {
												return (0, react_jsx_runtime.jsxs)("li", {
													className: "dshm_card dshm_orphanRow",
													...
													children: [
														(0, react_jsx_runtime.jsxs)("div", {
															...
															children: [
																...
																(0, react_jsx_runtime.jsx)("div", {
																	className: "dshm_cardText",
																	children: (0, react_jsx_runtime.jsx)("strong", { className: "dshm_cardName", title: orphan.path, children: orphan.name })
																}),
																(0, react_jsx_runtime.jsx)("span", { className: "dshm_badge dshm_badgeWarn", children: t("orphanTag") }),
																(0, react_jsx_runtime.jsxs)("div", {
																	className: "dshm_actions",
																	children: [
														...
														(0, react_jsx_runtime.jsx)("p", { className: "dshm_cardDesc dshm_orphanReason", children: reason })
													]
												}, orphan.name);
											}
											return (0, react_jsx_runtime.jsxs)("li", {
